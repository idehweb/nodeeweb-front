...
class CreateForm extends React.Component {
  ...
  returnFieldType({type, value, index = '',placeholder='',disabled=false}) {
    console.log('type', type,value, index)
        ...
        return (
          <Col
            ...
            <div>{field.value.map((val, index) => {
              return this.returnFieldType({type: 'object', value: val, index: index})
            })}</div>
        ...
        return (
          <Col
            ...
            {(field && field.value && !(field.value instanceof Array)) && Object.keys(field.value).map((val) => {
              ...
              return this.returnFieldType({type: typeof field.value[val], value: field.value[val], index: index})
