...
export function ShowElement(p) {
  ...
  switch (name) {
    ...
    case 'navigation':
      return (
        <TheMainNavbar element={element} content={content} params={params} />
      );
    case 'searchbar':
      return (
...
export function TheButton(p) {
    ...
    if (action == 'toggleMenu') {
      return (
        <Button
          ...
          className={
            ' posrel ' + classess + (showInMobile ? ' showInMobile ' : '')
          }
          style={style}>
          {Icons[iconFont] && (
            <span>{React.createElement(Icons[iconFont])}</span>
  ...
  if (iconFont) {
    return (
      <Button
        className={classess + (showInMobile ? ' showInMobile ' : '')}
        style={style}>
        {Icons[iconFont] && <span>{React.createElement(Icons[iconFont])}</span>}
        <span>{text}</span>
      </Button>
